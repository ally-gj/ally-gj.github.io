...
An outdoor rated camera, mounted at the top of the Space Needle, sends live stream data to the kiosk and refreshes the image of the city every 10 minutes or so. 

* 2023 - 24, Unity, C#, Bolin Outdoor Camera, Directus CMS
...
Users can select the veteran which they'd like to talk to, and then ask them questions about their experiences. 

* 2023 - 2024, Unity, C#, React.js, Vuplex, color-changing microphones

<a href="https://ideum.com/portfolio/voices-from-the-front">Read more about it here</a>
...
# <u>Da Vinci Science Center</u>
Myself and one other talented developer created a large-scale application for the Da Vinci Science Center where users can use one of the nine touch table kiosks to take a selfie, complete the specific activity (making a self portrait / make a flying machine / create a fit kid), and then send their “creation” to the 50 x 60 foot projected screen to see their creation integrated into a larger than life 3D scene.
...
[![](https://img.youtube.com/vi/WMGhTssv2vY/0.jpg)](https://youtu.be/WMGhTssv2vY)

Click to play video! Video credit: Ideum

# <u>Verizon POC</u>
Commissioned by Verizon to create a proof of concept system for their main offices in New Jersey.
This included a backend database of verizon plans, phones, accessories, and deals that were then loaded into the application at runtime and allowed users to create their own perfect plan. 
